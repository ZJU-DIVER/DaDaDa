...
You can also access our dataset on [Kaggle](https://www.kaggle.com/datasets/naweizhw/dadada/data).
## Environment
...
The best regression model for data product pricing can be downloaded from [here](https://drive.google.com/file/d/1G9Cb3qU1lTB8Z4TZQKfjWNTm90PcjTdC/view?usp=sharing).
）  
